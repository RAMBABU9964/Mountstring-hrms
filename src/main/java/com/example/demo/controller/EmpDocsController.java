...
import com.example.demo.service.EmpDocsService;
...
public class EmpDocsController {
	...
	public String handleFileUpload(@PathVariable("id") Long id,
			...
			@RequestParam("resume") MultipartFile resume, @RequestParam("aadhar") MultipartFile aadhar,
			@RequestParam("passportSizePhoto") MultipartFile passportSizePhoto,
			@RequestParam("githubLink") String githubLink, RedirectAttributes redirectAttributes) {
